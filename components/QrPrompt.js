...
//   if (props.isVCOffer) {
//     thePrompt =
//     `Your Verifiable Credential is ready. Either Scan the QR code or Tap the button to receive it in your wallet`;
//     topHeader = "Your protable KYB Credential is ready ";
//   } else {
//     thePrompt =  `Your Profile has been generated with PALAEMON. Additionally, you can scan the QR code with your Jolocom Wallet
//     to generate a Verifiable Credential that will give you access to on ship services `;
